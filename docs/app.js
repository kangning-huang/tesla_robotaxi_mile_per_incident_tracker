...
const incidentDataBase = [
    ...
    { date: '2026-07-01', days: 181, fleet: 121, miles: 2470545, mpi: 1235272, count: 2 },
];

// Stationary: no backing, WITH stationary (15 incidents) - previous default
const incidentDataStationary = [
    { date: '2025-07-15', days: 6, fleet: 11, miles: 19665, mpi: 2185, count: 9 },
    { date: '2025-09-15', days: 62, fleet: 14, miles: 106490, mpi: 11832, count: 9 },
    { date: '2025-10-15', days: 30, fleet: 17, miles: 62790, mpi: 20930, count: 3 },
    { date: '2025-11-12', days: 31, fleet: 18, miles: 66355, mpi: 33177, count: 2 },
    { date: '2025-12-10', days: 30, fleet: 26, miles: 86135, mpi: 43067, count: 2 },
    { date: '2026-01-10', days: 31, fleet: 33, miles: 122935, mpi: 20489, count: 6 },
    ...
    { date: '2026-05-01', days: 30, fleet: 94, miles: 324300, mpi: 324300, count: 1 },
    { date: '2026-06-01', days: 31, fleet: 112, miles: 399280, mpi: 399280, count: 1 },
    { date: '2026-07-01', days: 30, fleet: 121, miles: 421475, mpi: 210737, count: 2 },
];
...
const incidentDataBacking = [
    ...
    { date: '2025-10-15', days: 30, fleet: 17, miles: 62790, mpi: 20930, count: 3 },
    { date: '2025-12-10', days: 61, fleet: 26, miles: 171695, mpi: 85847, count: 2 },
    { date: '2026-01-10', days: 31, fleet: 33, miles: 130755, mpi: 16344, count: 8 },
    { date: '2026-06-01', days: 151, fleet: 105, miles: 1823325, mpi: 1823325, count: 1 },
    { date: '2026-07-01', days: 30, fleet: 121, miles: 421475, mpi: 210737, count: 2 },
];
...
const incidentDataAll = [
    ...
    { date: '2026-04-01', days: 31, fleet: 90, miles: 320850, mpi: 320850, count: 1 },
    { date: '2026-05-01', days: 30, fleet: 94, miles: 324300, mpi: 324300, count: 1 },
    { date: '2026-06-01', days: 31, fleet: 108, miles: 387205, mpi: 193602, count: 2 },
    { date: '2026-07-01', days: 30, fleet: 121, miles: 421475, mpi: 210737, count: 2 },
];
...
const incidentDataActiveBase = [
    ...
    { date: '2026-01-10', days: 31, fleet: 0, miles: 0, mpi: 0, count: 4 },
    { date: '2026-07-01', days: 181, fleet: 80, miles: 1488100, mpi: 744050, count: 2 },
];

// Stationary: no backing, WITH stationary
const incidentDataActiveStationary = [
    { date: '2025-07-15', days: 6, fleet: 0, miles: 0, mpi: 0, count: 9 },
    { date: '2025-09-15', days: 62, fleet: 0, miles: 0, mpi: 0, count: 9 },
    { date: '2025-10-15', days: 30, fleet: 0, miles: 0, mpi: 0, count: 3 },
    { date: '2025-11-12', days: 31, fleet: 0, miles: 0, mpi: 0, count: 2 },
    ...
    { date: '2026-05-01', days: 30, fleet: 12, miles: 41400, mpi: 41400, count: 1 },
    { date: '2026-06-01', days: 31, fleet: 53, miles: 188945, mpi: 188945, count: 1 },
    { date: '2026-07-01', days: 30, fleet: 80, miles: 255185, mpi: 127592, count: 2 },
];
...
const incidentDataActiveBacking = [
    ...
    { date: '2025-10-15', days: 30, fleet: 0, miles: 0, mpi: 0, count: 3 },
    { date: '2025-12-10', days: 61, fleet: 0, miles: 0, mpi: 0, count: 2 },
    { date: '2026-01-10', days: 31, fleet: 0, miles: 0, mpi: 0, count: 8 },
    { date: '2026-06-01', days: 151, fleet: 35, miles: 607775, mpi: 607775, count: 1 },
    { date: '2026-07-01', days: 30, fleet: 80, miles: 255185, mpi: 127592, count: 2 },
];
...
const incidentDataActiveAll = [
    ...
    { date: '2026-04-01', days: 31, fleet: 8, miles: 28520, mpi: 28520, count: 1 },
    { date: '2026-05-01', days: 30, fleet: 12, miles: 41400, mpi: 41400, count: 1 },
    { date: '2026-06-01', days: 31, fleet: 44, miles: 130870, mpi: 65435, count: 2 },
    { date: '2026-07-01', days: 30, fleet: 80, miles: 255185, mpi: 127592, count: 2 },
];

// ===== NHTSA Release-Window Datasets =====
// One point per NHTSA public data release. Each point's MPI denominator is
// "new Report IDs that first appeared in this release", which avoids the
// monthly clustering caused by NHTSA's date redaction. Auto-generated by
// scripts/sync_app_data.py from data/analysis_results.json by_release section.
const incidentDataReleaseBase = [
    { date: '2025-08-15', days: 31, fleet: 16, miles: 58765, mpi: 29382, count: 2, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 18, miles: 64170, mpi: 32085, count: 2, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 20, miles: 77165, mpi: 38582, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2026-01-15', days: 33, fleet: 74, miles: 270365, mpi: 135182, count: 2, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 89, miles: 287270, mpi: 287270, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
];
const incidentDataReleaseStationary = [
    { date: '2025-08-15', days: 31, fleet: 16, miles: 58765, mpi: 19588, count: 3, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 18, miles: 64170, mpi: 21390, count: 3, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 20, miles: 77165, mpi: 38582, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2025-11-17', days: 28, fleet: 29, miles: 95795, mpi: 95795, count: 1, windowStart: '2025-11-17', throughDate: '2025-11-17', releaseDate: '2025-12-15' },
    { date: '2026-01-15', days: 33, fleet: 74, miles: 270365, mpi: 90121, count: 3, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 89, miles: 287270, mpi: 287270, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
    { date: '2026-04-15', days: 60, fleet: 96, miles: 670680, mpi: 335340, count: 2, windowStart: '2026-03-16', throughDate: '2026-04-15', releaseDate: '2026-05-15' },
];
const incidentDataReleaseBacking = [
    { date: '2025-08-15', days: 31, fleet: 16, miles: 58765, mpi: 29382, count: 2, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 18, miles: 64170, mpi: 32085, count: 2, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 20, miles: 77165, mpi: 38582, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2026-01-15', days: 33, fleet: 74, miles: 270365, mpi: 67591, count: 4, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 89, miles: 287270, mpi: 287270, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
];
const incidentDataReleaseAll = [
    { date: '2025-08-15', days: 31, fleet: 16, miles: 58765, mpi: 19588, count: 3, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 18, miles: 64170, mpi: 21390, count: 3, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 20, miles: 77165, mpi: 38582, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2025-11-17', days: 28, fleet: 29, miles: 95795, mpi: 95795, count: 1, windowStart: '2025-11-17', throughDate: '2025-11-17', releaseDate: '2025-12-15' },
    { date: '2026-01-15', days: 33, fleet: 74, miles: 270365, mpi: 54073, count: 5, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 89, miles: 287270, mpi: 287270, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
    { date: '2026-04-15', days: 60, fleet: 96, miles: 670680, mpi: 335340, count: 2, windowStart: '2026-03-16', throughDate: '2026-04-15', releaseDate: '2026-05-15' },
];
const incidentDataReleaseActiveBase = [
    { date: '2025-08-15', days: 31, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2026-01-15', days: 33, fleet: 3, miles: 11615, mpi: 5807, count: 2, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 8, miles: 25185, mpi: 25185, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
];
const incidentDataReleaseActiveStationary = [
    { date: '2025-08-15', days: 31, fleet: 0, miles: 0, mpi: 0, count: 3, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 0, miles: 0, mpi: 0, count: 3, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2025-11-17', days: 28, fleet: 0, miles: 0, mpi: 0, count: 1, windowStart: '2025-11-17', throughDate: '2025-11-17', releaseDate: '2025-12-15' },
    { date: '2026-01-15', days: 33, fleet: 3, miles: 11615, mpi: 3871, count: 3, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 8, miles: 25185, mpi: 25185, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
    { date: '2026-04-15', days: 60, fleet: 15, miles: 103155, mpi: 51577, count: 2, windowStart: '2026-03-16', throughDate: '2026-04-15', releaseDate: '2026-05-15' },
];
const incidentDataReleaseActiveBacking = [
    { date: '2025-08-15', days: 31, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2026-01-15', days: 33, fleet: 3, miles: 11615, mpi: 2903, count: 4, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 8, miles: 25185, mpi: 25185, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
];
const incidentDataReleaseActiveAll = [
    { date: '2025-08-15', days: 31, fleet: 0, miles: 0, mpi: 0, count: 3, windowStart: '2025-08-15', throughDate: '2025-08-15', releaseDate: '2025-09-15' },
    { date: '2025-09-15', days: 30, fleet: 0, miles: 0, mpi: 0, count: 3, windowStart: '2025-09-15', throughDate: '2025-09-15', releaseDate: '2025-10-15' },
    { date: '2025-10-15', days: 33, fleet: 0, miles: 0, mpi: 0, count: 2, windowStart: '2025-10-15', throughDate: '2025-10-15', releaseDate: '2025-11-17' },
    { date: '2025-11-17', days: 28, fleet: 0, miles: 0, mpi: 0, count: 1, windowStart: '2025-11-17', throughDate: '2025-11-17', releaseDate: '2025-12-15' },
    { date: '2026-01-15', days: 33, fleet: 3, miles: 11615, mpi: 2323, count: 5, windowStart: '2026-01-15', throughDate: '2026-01-15', releaseDate: '2026-02-17' },
    { date: '2026-02-17', days: 27, fleet: 8, miles: 25185, mpi: 25185, count: 1, windowStart: '2026-02-17', throughDate: '2026-02-17', releaseDate: '2026-03-16' },
    { date: '2026-04-15', days: 60, fleet: 15, miles: 103155, mpi: 51577, count: 2, windowStart: '2026-03-16', throughDate: '2026-04-15', releaseDate: '2026-05-15' },
];
...
const latestActiveFleetSize = 200;
...
let groupByNHTSARelease = true;

// Get current incident data based on aggregation mode, fleet mode, and filters
function getIncidentData() {
    const isActive = fleetMode === 'active';

    if (groupByNHTSARelease) {
        if (includeBackingIncidents && includeStationaryIncidents) {
            return isActive ? incidentDataReleaseActiveAll : incidentDataReleaseAll;
        } else if (includeBackingIncidents) {
            return isActive ? incidentDataReleaseActiveBacking : incidentDataReleaseBacking;
        } else if (includeStationaryIncidents) {
            return isActive ? incidentDataReleaseActiveStationary : incidentDataReleaseStationary;
        }
        return isActive ? incidentDataReleaseActiveBase : incidentDataReleaseBase;
    }
...
const fleetData = [
    ...
    { date: '2026-02-22', size: 89 },
    { date: '2026-02-23', size: 89 },
    { date: '2026-02-24', size: 89 },
    { date: '2026-02-25', size: 89 },
    { date: '2026-02-26', size: 89 },
    { date: '2026-02-27', size: 89 },
    { date: '2026-02-28', size: 89 },
    { date: '2026-03-01', size: 89 },
    { date: '2026-04-16', size: 94 },
    { date: '2026-04-17', size: 96 },
    { date: '2026-04-18', size: 96 },
    { date: '2026-04-19', size: 96 },
    { date: '2026-04-20', size: 96 },
    { date: '2026-04-21', size: 96 },
    { date: '2026-08-14', size: 143 },
    { date: '2026-08-15', size: 143 },
    { date: '2026-08-16', size: 143 },
    { date: '2026-08-17', size: 143 },
    { date: '2026-08-18', size: 146 },
    { date: '2026-08-20', size: 152 },
    { date: '2026-08-21', size: 153 },
    { date: '2026-08-22', size: 154 },
    { date: '2026-08-23', size: 155 },
    { date: '2026-08-24', size: 155 },
    { date: '2026-08-31', size: 109 },
    { date: '2026-09-01', size: 110 },
    { date: '2026-09-02', size: 114 },
    { date: '2026-09-03', size: 114 },
    { date: '2026-09-04', size: 119 },
    { date: '2026-09-05', size: 166 },
    { date: '2026-09-06', size: 181 },
    { date: '2026-09-07', size: 189 },
    { date: '2026-09-08', size: 192 },
    { date: '2026-09-09', size: 193 },
    { date: '2026-09-10', size: 194 },
    { date: '2026-09-11', size: 194 },
    { date: '2026-09-12', size: 194 },
    { date: '2026-09-13', size: 194 },
    { date: '2026-09-14', size: 197 },
    { date: '2026-09-15', size: 197 },
    { date: '2026-09-16', size: 197 },
    { date: '2026-09-17', size: 197 },
    { date: '2026-09-18', size: 198 },
    { date: '2026-09-19', size: 198 },
    { date: '2026-09-20', size: 198 },
    { date: '2026-09-21', size: 198 },
    { date: '2026-09-22', size: 198 },
    { date: '2026-09-23', size: 200 },
];
...
// Compute initial trend using current toggle defaults (release-window view).
// Depends on getIncidentData() (hoisted function) and the state variables
// declared above (groupByNHTSARelease, fleetMode, filter flags).
const fit = computeExponentialFit(getIncidentData());
let trendParams = {
...
function updateIncidentFilters() {
    ...
    const releaseToggleBtn = document.querySelector('.aggregation-toggle-btn.active');
    ...
    if (releaseToggleBtn) {
        groupByNHTSARelease = releaseToggleBtn.dataset.mode === 'release';
    }
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Set up aggregation mode toggle (NHTSA release window vs. monthly view)
    document.querySelectorAll('.aggregation-toggle-btn').forEach(btn => {
        btn.addEventListener('click', () => {
            document.querySelectorAll('.aggregation-toggle-btn').forEach(b => b.classList.remove('active'));
